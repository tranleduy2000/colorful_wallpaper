...
public final class UpdateVertexBufferRenderer extends AbstractRenderer {
    ...
    public UpdateVertexBufferRenderer(Context context, @Nullable AbstractFragment fragment) {
